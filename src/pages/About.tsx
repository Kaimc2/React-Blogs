...
export const About = () => {
  ...
  return (
    <section className="flex justify-center items-center dark:bg-slate-900 dark:text-slate-300 md:h-[82vh] ">
      <div className="mx-5 flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="p-10 space-y-8">
          <h1 className="text-[2rem]">About this project:</h1>
          <p className="text-lg">
            Welcome to my coding adventure, where I'm building this blog from
            the ground up. Rest assured, I embrace mistakes as opportunities to
            learn and grow.
          </p>
